...
export class CustomIcons {
  ...
  render() {
    switch (this.iconName) {
      case 'home':
        return (
          <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
      ...
      case 'colorful':
        return (
          <svg viewBox="0 0 235 234" xmlns="http://www.w3.org/2000/svg" class="icon rainbow-logo" preserveAspectRatio="xMinYMin meet" width="24" height="24">
      ...
      case 'hamburger':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a84ws8s1nytx0v2vudm6gno5yeqaa2xe" class="crayons-icon">
            <title id="a84ws8s1nytx0v2vudm6gno5yeqaa2xe">Navigation menu</title>
      ...
      case 'close':
        return (
          <svg
            ...
            viewBox="0 0 24 24"
            role="img"
            aria-labelledby="aflnebjvrdesn7qp5rwuhu9rgutzh00k"
            aria-hidden="true"
            class="crayons-icon c-btn__icon"
          >
            <title id="aflnebjvrdesn7qp5rwuhu9rgutzh00k">Close</title>
